...
for (var j = 1; j<= 4; j++)
{ 
    var name_of_the_student = document.getElementById("name_of_the_student"+)
    ariaValueMax;
    console.log(name_of_the_student_array);

    for (var k = 0; k < lenght_of_name_of-students_array; k++)
    {
display_student_array.push("<h4>NAME - "+ name_of_the_students_array[k] + "<")
...
console.log(remove_commas);
documents.getElementById("display_name_without_commas").innerHTML = remove_commas;
